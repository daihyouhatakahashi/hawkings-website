  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
      ...
      <button
        ...
        className="block mx-auto px-8 md:px-14 py-[1.125rem] bg-hawkings-black text-white text-[11px] font-medium uppercase tracking-extra-wide border border-hawkings-black hover:bg-white hover:text-hawkings-black transition-hawkings disabled:opacity-50 disabled:cursor-not-allowed"
      >
